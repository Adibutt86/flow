...
5. SAFE CLOTHING & PHYSICAL DESCRIPTIONS (CRITICAL FOR MINORS): When describing toddlers, babies, or children, you MUST avoid sensitive words that falsely trigger AI safety filters (CSAM filters). DO NOT use words like "pouty", "chest", "loosely draped", "lips moving", or focus heavily on "long lashes". Instead, use safe alternatives like "silly expression", "expressive face", "holding closely", and "mouth moving naturally". Keep clothing descriptions modest and safe (e.g. "matching dupatta", "buttoned shirt").
...
function generateFallbackIdeaPrompt(input: any): string[] {
  ...
  if (cat === "CHARACTER_BIBLE") {
    return [
      ...
      `• Personality & Mannerisms: Curious, mischievous, highly expressive, subtle smiles, avoids exaggerated laughing\n` +
