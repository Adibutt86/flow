...
const FB_CHARACTER_STYLE_GROUPS = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: "3D Cute Baby & Teddy Bear", label: "3D Cute Baby & Teddy Bear", desc: "Adorable 3D baby holding a plush teddy bear", tag: "🧸 Kids Favorite" },
      ...
      { value: "Royal Desi Prince / Princess", label: "Royal Desi Prince / Princess", desc: "Regal velvet sherwani / lehenga royal posture" },
  ...
  },
  {
    ...
    options: [
      { value: "Frosted Glassmorphism Avatar", label: "Frosted Glassmorphism Avatar", desc: "Translucent frosted 3D character render" },
...
const FB_TYPOGRAPHY_GROUPS = [
  {
    ...
    options: [
      ...
      { value: "Neon Tube 3D Glowing Text", label: "💡 Neon Tube 3D Glowing Text", desc: "Vibrant glowing neon tube typography" },
      { value: "Gold Foil & Embossed Leaf Text", label: "👑 Gold Foil & Embossed Text", desc: "Luxurious 3D gold leaf embossed letters" },
      ...
      { value: "Dual Gradient Keyword Accents", label: "🌈 Dual Gradient Keyword Accents", desc: "Dynamic multi-color gradient keyword highlights" },
      { value: "3D Layered Paper Cutout Font", label: "✂️ 3D Layered Paper Cutout Font", desc: "Paper craft typography with drop shadow depth" },
...
const FB_LAYOUT_GROUPS = [
  {
    ...
    options: [
      ...
      { value: "Floating Glassmorphism Quote Card", label: "Floating Glassmorphism Card", desc: "Translucent glass quote card over 3D character" },
      { value: "Polaroid Vintage Photo Frame", label: "Polaroid Vintage Photo Frame", desc: "Quote inside classic white Polaroid photo frame" },
      { value: "Magazine Cover Editorial Layout", label: "Magazine Cover Editorial", desc: "Bold headline quote top, centered character below" },
      { value: "Dual Character Speech Bubble Conversation", label: "Dual Character Speech Bubbles", desc: "Two characters with conversation speech bubbles" },
...
const FB_BACKGROUND_GROUPS = [
  {
    ...
    options: [
      ...
      { value: "Frosted Glassmorphism Ambient", label: "🔮 Frosted Glassmorphism Ambient", desc: "Soft blurred frosted glass with ambient glow" },
      { value: "Moonlit Starry Night Sky", label: "🌙 Moonlit Starry Night Sky", desc: "Deep blue night sky with crescent moon & stars" },
      { value: "Pastel Cloud Sunset", label: "☁️ Pastel Cloud Sunset", desc: "Soft pink & violet cotton-candy sunset" },
      { value: "White Marble & Gold Veins", label: "🏛️ White Marble & Gold Veins", desc: "Luxurious white marble with subtle gold accents" },
...
const FB_DECORATION_GROUPS = [
  {
    ...
    options: [
      ...
      { value: "Glowing Musical Notes & Feathers", label: "🎵 Glowing Music Notes & Feathers", desc: "Floating 3D glowing music notes & white feathers" },
      { value: "Floating Red Rose Petals", label: "🌹 Floating Red Rose Petals", desc: "Drifting romantic red rose petals & sparkles" },
      { value: "Diamond Particles & Crystal Dust", label: "💎 Diamond Dust & Crystals", desc: "Glittering diamond light dust & crystal stars" },
