...
const CUTE_KIDS_PRESET_GROUPS = [
  ...
  },
  {
    ...
    presets: [
      ...
      { icon: "🩺", title: "Boy Doctor", age: "Child (5-8 yrs)", location: "Kids Hospital Clinic", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Doctor Coat & Stethoscope", prop: "Toy Stethoscope 🩺" },
      { icon: "🦷", title: "Boy Dentist", age: "Child (5-8 yrs)", location: "Dental Clinic Desk", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Dentist Scrubs & Mask", prop: "Toy Toothbrush & Mirror 🦷" },
      { icon: "👩‍🏫", title: "Boy Teacher", age: "Child (5-8 yrs)", location: "School Classroom & Blackboard", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Formal Teacher Shirt & Glasses", prop: "Chalk & Pointer Stick 📏" },
      { icon: "👮", title: "Boy Police Officer", age: "Child (5-8 yrs)", location: "Police Station Counter", health: "Healthy", vibe: "Funny & Mischievous", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Mini Police Uniform", prop: "Toy Badge & Whistle 👮" },
      { 
        icon: "👮‍♂️", 
        title: "Pakistani Chubby Police & Assistant", 
        age: "Toddler (2-4 yrs)", 
        location: "Authentic Pakistani Police Station 👮‍♂️", 
        health: "Chubby & Cute", 
        vibe: "Funny & Mischievous", 
        setup: "Two Boy Friends (Speaker & Listener)", 
        perScene: "2 Characters", 
        nationality: "Pakistani (General / Desi)", 
        clothing: "Boy — Oversized Pakistani Police Uniform & Cap", 
        prop: "Files & Police Desk 📂",
        customSceneDescription: "An authentic Pakistani police station interior (wooden police desk, files, registers, old desktop computer, notice boards, official paperwork, wall clock, metal chairs). Character 1: A very chubby toddler police officer with round cheeks and a funny serious expression, sitting confidently behind the desk in an oversized, slightly comical Pakistani police uniform and police cap. He acts overly strict and authoritative. Character 2: His toddler police assistant, slightly slimmer and shorter, standing beside the desk helping with files. Assistant wears a smaller Pakistani police uniform and cap, and has a confused but obedient expression. Both have natural expressive eyes, chubby toddler features, realistic 3D cartoon rendering, soft PBR materials, detailed clothing, natural body movement, and clear visual differences. No adult characters, no weapons, no violence, no text/logos."
      },
      { icon: "👨‍🍳", title: "Boy Chef", age: "Child (5-8 yrs)", location: "Modern Kitchen", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Chef Apron & Hat", prop: "Rolling Pin & Spoon 🥄" },
      { icon: "🛒", title: "Boy Shopkeeper", age: "Child (5-8 yrs)", location: "Bustling Desi Bazaar & Grocery Shop", health: "Healthy", vibe: "Funny & Mischievous", setup: "Boy & Shopkeeper", perScene: "2 Characters", nationality: "Global / Any", clothing: "Boy — Shopkeeper Apron", prop: "Toy Cash Register 🛒" },
      { icon: "🚕", title: "Boy Driver", age: "Child (5-8 yrs)", location: "Taxi Driver Seat", health: "Healthy", vibe: "Funny & Mischievous", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Driver Cap & Uniform", prop: "Toy Steering Wheel 🚗" },
      { icon: "🧑‍🔧", title: "Boy Mechanic", age: "Child (5-8 yrs)", location: "Auto Repair Garage", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Mechanic Denim Overalls", prop: "Toy Wrench & Spanner 🔧" },
      { icon: "📸", title: "Boy Photographer", age: "Child (5-8 yrs)", location: "Scenic Photo Studio & Park", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Casual Vest & Cap", prop: "Camera with Flash 📸" },
      { icon: "🧑‍🌾", title: "Boy Farmer", age: "Child (5-8 yrs)", location: "Green Farm & Wheat Field", health: "Healthy", vibe: "Sweet & Wholesome", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Farmer Straw Hat & Kurta", prop: "Mini Rake & Watering Can 🧑‍🌾" },
      { icon: "🍦", title: "Boy Ice Cream Seller", age: "Toddler (2-4 yrs)", location: "Colorful Ice Cream Cart in Park", health: "Healthy", vibe: "Funny & Mischievous", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Striped Apron & Cap", prop: "Ice Cream Cone 🍦" },
      { icon: "🥖", title: "Boy Baker", age: "Child (5-8 yrs)", location: "Warm Bakery Counter & Oven", health: "Healthy", vibe: "Sweet & Wholesome", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — White Baker Coat & Hat", prop: "Fresh Bakery Bread 🥖" },
      { icon: "✂️", title: "Boy Tailor", age: "Child (5-8 yrs)", location: "Desi Tailor Shop", health: "Healthy", vibe: "Funny & Mischievous", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Tailor Vest with Measuring Tape", prop: "Measuring Tape & Scissors ✂️" },
      { icon: "✈️", title: "Boy Pilot", age: "Child (5-8 yrs)", location: "Airplane Cockpit Window", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Pilot Aviator Suit & Goggles", prop: "Toy Airplane ✈️" },
      { icon: "🚒", title: "Boy Firefighter", age: "Child (5-8 yrs)", location: "Fire Station Engine Truck", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Yellow Firefighter Helmet & Coat", prop: "Toy Hose Nozzle 🚒" },
      { icon: "📚", title: "Boy Librarian", age: "Child (5-8 yrs)", location: "Quiet Library Bookcases", health: "Healthy", vibe: "Sweet & Wholesome", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Cardigan & Glasses", prop: "Storybook 📚" },
      { icon: "🧑‍🎨", title: "Boy Artist", age: "Child (5-8 yrs)", location: "Art Studio Canvas Easel", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Paint Splattered Smock & Beret", prop: "Paintbrush & Palette 🎨" },
      { icon: "🧑‍💻", title: "Boy Computer Expert", age: "Child (5-8 yrs)", location: "Computer Lab Desk & Screen", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Tech Hoodie & Headphones", prop: "Toy Laptop 💻" },
      { icon: "🎤", title: "Boy News Reporter", age: "Child (5-8 yrs)", location: "TV News Studio Desk", health: "Healthy", vibe: "Funny & Mischievous", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Blazer & News Badge", prop: "Press Microphone 🎤" },
      { icon: "🎬", title: "Boy Actor", age: "Child (5-8 yrs)", location: "Red Carpet Movie Stage", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Stylish Suit & Sunglasses", prop: "Golden Award Trophy 🏆" },
      { icon: "🏋️", title: "Boy Gym Trainer", age: "Child (5-8 yrs)", location: "Kids Gym & Fitness Mat", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Sporty Sweatband & Tank Top", prop: "Mini Dumbbells 🏋️" },
      { icon: "🐾", title: "Boy Vet", age: "Child (5-8 yrs)", location: "Pet Animal Clinic Counter", health: "Healthy", vibe: "Sweet & Wholesome", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Vet Coat & Pet Badge", prop: "Toy Stethoscope & Plush Kitten 🐾" },
      { icon: "🚗", title: "Boy Car Wash", age: "Child (5-8 yrs)", location: "Soapy Car Wash Station", health: "Healthy", vibe: "Funny & Mischievous", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Waterproof Apron & Boots", prop: "Sponge & Water Spray 🚗" },
      { icon: "⛽", title: "Boy Petrol Pump", age: "Child (5-8 yrs)", location: "Fuel Pump Station", health: "Healthy", vibe: "Funny & Mischievous", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Gas Station Uniform & Cap", prop: "Toy Fuel Nozzle ⛽" },
      { icon: "🏨", title: "Boy Hotel Receptionist", age: "Child (5-8 yrs)", location: "Grand Hotel Lobby Desk", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Hotel Suit & Bellhop Cap", prop: "Desk Service Bell 🔔" },
      { icon: "🍔", title: "Boy Fast Food Worker", age: "Child (5-8 yrs)", location: "Fast Food Counter", health: "Healthy", vibe: "Funny & Mischievous", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Diner Uniform & Cap", prop: "Toy Burger & Fries 🍔" },
      { icon: "🚌", title: "Boy School Bus Driver", age: "Child (5-8 yrs)", location: "Yellow School Bus Driver Seat", health: "Healthy", vibe: "Funny & Mischievous", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Bus Driver Cap & Shirt", prop: "Toy Steering Wheel 🚌" },
      { icon: "🎁", title: "Boy Toy Shopkeeper", age: "Child (5-8 yrs)", location: "Bright Toy Store Shelves", health: "Healthy", vibe: "Sweet & Wholesome", setup: "One Cute Little Boy", perScene: "1 Character", nationality: "Global / Any", clothing: "Boy — Colorful Apron & Name Tag", prop: "Plush Teddy Bear 🎁" },
    ]
  },
  {
    ...
    presets: [
      ...
      { icon: "🩺", title: "Girl Doctor", age: "Child (5-8 yrs)", location: "Kids Hospital Clinic", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Girl", perScene: "1 Character", nationality: "Global / Any", clothing: "Girl — Doctor Coat & Stethoscope", prop: "Toy Stethoscope 🩺" },
      { icon: "🦷", title: "Girl Dentist", age: "Child (5-8 yrs)", location: "Dental Clinic Desk", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Girl", perScene: "1 Character", nationality: "Global / Any", clothing: "Girl — Dentist Scrubs & Mask", prop: "Toy Toothbrush & Mirror 🦷" },
      { icon: "👩‍🏫", title: "Girl Teacher", age: "Child (5-8 yrs)", location: "School Classroom & Blackboard", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Girl", perScene: "1 Character", nationality: "Global / Any", clothing: "Girl — Teacher Suit & Spectacles", prop: "Chalk & Pointer Stick 📏" },
      { icon: "👮", title: "Girl Police Officer", age: "Child (5-8 yrs)", location: "Police Station Counter", health: "Healthy", vibe: "Funny & Mischievous", setup: "One Cute Little Girl", perScene: "1 Character", nationality: "Global / Any", clothing: "Girl — Mini Police Uniform", prop: "Toy Badge & Whistle 👮" },
      { icon: "👨‍🍳", title: "Girl Chef", age: "Child (5-8 yrs)", location: "Modern Kitchen", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Girl", perScene: "1 Character", nationality: "Global / Any", clothing: "Girl — Chef Apron & Hat", prop: "Whisk & Bowl 🥣" },
      { icon: "🛒", title: "Girl Shopkeeper", age: "Child (5-8 yrs)", location: "Bustling Desi Bazaar & Grocery Shop", health: "Healthy", vibe: "Funny & Mischievous", setup: "Girl & Shopkeeper", perScene: "2 Characters", nationality: "Global / Any", clothing: "Girl — Shopkeeper Vest", prop: "Toy Cash Register 🛒" },
      { icon: "🚕", title: "Girl Driver", age: "Child (5-8 yrs)", location: "Taxi Driver Seat", health: "Healthy", vibe: "Funny & Mischievous", setup: "One Cute Little Girl", perScene: "1 Character", nationality: "Global / Any", clothing: "Girl — Driver Cap & Vest", prop: "Toy Steering Wheel 🚗" },
      { icon: "🧑‍🔧", title: "Girl Mechanic", age: "Child (5-8 yrs)", location: "Auto Repair Garage", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Girl", perScene: "1 Character", nationality: "Global / Any", clothing: "Girl — Mechanic Denim Overalls", prop: "Toy Wrench & Spanner 🔧" },
      { icon: "📸", title: "Girl Photographer", age: "Child (5-8 yrs)", location: "Scenic Photo Studio & Park", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Girl", perScene: "1 Character", nationality: "Global / Any", clothing: "Girl — Trendy Jacket & Beret", prop: "Camera with Flash 📸" },
      { icon: "🧑‍🌾", title: "Girl Farmer", age: "Child (5-8 yrs)", location: "Green Farm & Wheat Field", health: "Healthy", vibe: "Sweet & Wholesome", setup: "One Cute Little Girl", perScene: "1 Character", nationality: "Global / Any", clothing: "Girl — Farmer Straw Hat & Dress", prop: "Mini Rake & Basket 🧺" },
      { icon: "🍦", title: "Girl Ice Cream Seller", age: "Toddler (2-4 yrs)", location: "Colorful Ice Cream Cart in Park", health: "Healthy", vibe: "Funny & Mischievous", setup: "One Cute Little Girl", perScene: "1 Character", nationality: "Global / Any", clothing: "Girl — Pastel Apron & Visor", prop: "Ice Cream Cone 🍦" },
      { icon: "🥖", title: "Girl Baker", age: "Child (5-8 yrs)", location: "Warm Bakery Counter & Oven", health: "Healthy", vibe: "Sweet & Wholesome", setup: "One Cute Little Girl", perScene: "1 Character", nationality: "Global / Any", clothing: "Girl — Pink Baker Apron & Chef Hat", prop: "Decorated Cupcake 🧁" },
      { icon: "✂️", title: "Girl Tailor", age: "Child (5-8 yrs)", location: "Desi Tailor Shop", health: "Healthy", vibe: "Funny & Mischievous", setup: "One Cute Little Girl", perScene: "1 Character", nationality: "Global / Any", clothing: "Girl — Tailor Apron with Measuring Tape", prop: "Measuring Tape & Chalk ✂️" },
      { icon: "✈️", title: "Girl Pilot", age: "Child (5-8 yrs)", location: "Airplane Cockpit Window", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Girl", perScene: "1 Character", nationality: "Global / Any", clothing: "Girl — Pilot Uniform Cap & Suit", prop: "Toy Airplane ✈️" },
      { icon: "🚒", title: "Girl Firefighter", age: "Child (5-8 yrs)", location: "Fire Station Engine Truck", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Girl", perScene: "1 Character", nationality: "Global / Any", clothing: "Girl — Red Firefighter Helmet & Coat", prop: "Toy Hose Nozzle 🚒" },
      { icon: "📚", title: "Girl Librarian", age: "Child (5-8 yrs)", location: "Quiet Library Bookcases", health: "Healthy", vibe: "Sweet & Wholesome", setup: "One Cute Little Girl", perScene: "1 Character", nationality: "Global / Any", clothing: "Girl — Cardigan & Spectacles", prop: "Storybook 📚" },
      { icon: "🧑‍🎨", title: "Girl Artist", age: "Child (5-8 yrs)", location: "Art Studio Canvas Easel", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Girl", perScene: "1 Character", nationality: "Global / Any", clothing: "Girl — Paint Splattered Apron & Beret", prop: "Paintbrush & Palette 🎨" },
      { icon: "🧑‍💻", title: "Girl Computer Expert", age: "Child (5-8 yrs)", location: "Computer Lab Desk & Screen", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Girl", perScene: "1 Character", nationality: "Global / Any", clothing: "Girl — Tech Hoodie & Headphones", prop: "Toy Laptop 💻" },
      { icon: "🎤", title: "Girl News Reporter", age: "Child (5-8 yrs)", location: "TV News Studio Desk", health: "Healthy", vibe: "Funny & Mischievous", setup: "One Cute Little Girl", perScene: "1 Character", nationality: "Global / Any", clothing: "Girl — Smart Blazer & News Badge", prop: "Press Microphone 🎤" },
      { icon: "🎬", title: "Girl Actress", age: "Child (5-8 yrs)", location: "Red Carpet Movie Stage", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Girl", perScene: "1 Character", nationality: "Global / Any", clothing: "Girl — Glamorous Dress & Tiara", prop: "Golden Award Trophy 🏆" },
      { icon: "🏋️", title: "Girl Gym Trainer", age: "Child (5-8 yrs)", location: "Kids Gym & Fitness Mat", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Girl", perScene: "1 Character", nationality: "Global / Any", clothing: "Girl — Sporty Headband & Tracksuit", prop: "Mini Dumbbells 🏋️" },
      { icon: "🐾", title: "Girl Vet", age: "Child (5-8 yrs)", location: "Pet Animal Clinic Counter", health: "Healthy", vibe: "Sweet & Wholesome", setup: "One Cute Little Girl", perScene: "1 Character", nationality: "Global / Any", clothing: "Girl — Vet Coat & Pet Badge", prop: "Toy Stethoscope & Plush Puppy 🐾" },
      { icon: "🚗", title: "Girl Car Wash", age: "Child (5-8 yrs)", location: "Soapy Car Wash Station", health: "Healthy", vibe: "Funny & Mischievous", setup: "One Cute Little Girl", perScene: "1 Character", nationality: "Global / Any", clothing: "Girl — Waterproof Apron & Boots", prop: "Sponge & Water Spray 🚗" },
      { icon: "⛽", title: "Girl Petrol Pump", age: "Child (5-8 yrs)", location: "Fuel Pump Station", health: "Healthy", vibe: "Funny & Mischievous", setup: "One Cute Little Girl", perScene: "1 Character", nationality: "Global / Any", clothing: "Girl — Gas Station Uniform & Cap", prop: "Toy Fuel Nozzle ⛽" },
      { icon: "🏨", title: "Girl Hotel Receptionist", age: "Child (5-8 yrs)", location: "Grand Hotel Lobby Desk", health: "Healthy", vibe: "Cheerful & Energetic", setup: "One Cute Little Girl", perScene: "1 Character", nationality: "Global / Any", clothing: "Girl — Hotel Suit & Badge", prop: "Desk Service Bell 🔔" },
  ...
  },
  {
    ...
    presets: [
      ...
      { icon: "🏖️", title: "Boy Beach Adventure", age: "Child (5-8 yrs)", location: "Sunny Tropical Beach & Shore", health: "Healthy", vibe: "Cheerful & Energetic", setup: "Two Boy Friends (Speaker & Listener)", perScene: "2 Characters", nationality: "Global / Any", prop: "Beach Bucket & Shovel 🪣" },
      { icon: "🏖️", title: "Girl Beach Adventure", age: "Child (5-8 yrs)", location: "Sunny Tropical Beach & Shore", health: "Healthy", vibe: "Cheerful & Energetic", setup: "Two Girl Friends (Speaker & Listener)", perScene: "2 Characters", nationality: "Global / Any", prop: "Beach Bucket & Shovel 🪣" },
      { icon: "🌳", title: "Boy Park Fun", age: "Toddler (2-4 yrs)", location: "Sunny Park & Green Lawn", health: "Healthy", vibe: "Cheerful & Energetic", setup: "Two Boy Friends (Speaker & Listener)", perScene: "2 Characters", nationality: "Global / Any" },
      { icon: "🌳", title: "Girl Park Fun", age: "Toddler (2-4 yrs)", location: "Sunny Park & Green Lawn", health: "Healthy", vibe: "Cheerful & Energetic", setup: "Two Girl Friends (Speaker & Listener)", perScene: "2 Characters", nationality: "Global / Any" },
      { icon: "🎡", title: "Boy Amusement Park", age: "Child (5-8 yrs)", location: "Amusement Park & Carnival Rides", health: "Healthy", vibe: "Cheerful & Energetic", setup: "Two Boy Friends (Speaker & Listener)", perScene: "2 Characters", nationality: "Global / Any", food: "Cotton Candy 🍬" },
      { icon: "🎡", title: "Girl Amusement Park", age: "Child (5-8 yrs)", location: "Amusement Park & Carnival Rides", health: "Healthy", vibe: "Cheerful & Energetic", setup: "Two Girl Friends (Speaker & Listener)", perScene: "2 Characters", nationality: "Global / Any", food: "Cotton Candy 🍬" },
      { icon: "🎂", title: "Boy Birthday Party", age: "Child (5-8 yrs)", location: "Decorated Birthday Party Room", health: "Healthy", vibe: "Cheerful & Energetic", setup: "Two Boy Friends (Speaker & Listener)", perScene: "2 Characters", nationality: "Global / Any", food: "Birthday Cake Slice 🎂" },
      { icon: "🎂", title: "Girl Birthday Party", age: "Child (5-8 yrs)", location: "Decorated Birthday Party Room", health: "Healthy", vibe: "Cheerful & Energetic", setup: "Two Girl Friends (Speaker & Listener)", perScene: "2 Characters", nationality: "Global / Any", food: "Birthday Cake Slice 🎂" },
      { icon: "🛝", title: "Boy Playground", age: "Toddler (2-4 yrs)", location: "Sunny Playground & Swings", health: "Healthy", vibe: "Cheerful & Energetic", setup: "Two Boy Friends (Speaker & Listener)", perScene: "2 Characters", nationality: "Global / Any" },
      { icon: "🛝", title: "Girl Playground", age: "Toddler (2-4 yrs)", location: "Sunny Playground & Swings", health: "Healthy", vibe: "Cheerful & Energetic", setup: "Two Girl Friends (Speaker & Listener)", perScene: "2 Characters", nationality: "Global / Any" },
    ]
  },
  {
  ...
  },
  {
    ...
    presets: [
      ...
      { icon: "👳‍♂️", title: "Funny Sikh", age: "Toddler (2-4 yrs)", location: "Pakistani Punjabi Village Fields & Mud Houses", health: "Healthy", vibe: "Funny & Mischievous", setup: "Sikh Boy & Father", perScene: "2 Characters", nationality: "Pakistani Punjabi (پنجابی)", clothing: "Traditional Sikh Turban & Kurta Pajama" },
      { icon: "🤣👳‍♂️", title: "Sikh Joke", age: "Toddler (2-4 yrs)", location: "Pakistani Punjabi Village Courtyard & Tubewell", health: "Healthy", vibe: "Funny & Mischievous", setup: "Two Sikh Friends", perScene: "2 Characters", nationality: "Pakistani Punjabi (پنجابی)", clothing: "Colorful Turbans & Kurta Pajama" },
      { icon: "👳‍♂️👧", title: "Sikh Girl and boy", age: "Toddler (2-4 yrs)", location: "Pakistani Punjabi Village Haveli & Charpai", health: "Healthy", vibe: "Funny & Mischievous", setup: "Sikh Boy & Sikh Girl", perScene: "2 Characters", nationality: "Pakistani Punjabi (پنجابی)", clothing: "Sikh Turban & Traditional Punjabi Suit" },
    ]
  },
  {
  ...
  },
  {
    ...
    presets: [
      ...
      {
        icon: "🐱",
        title: "Dancing with Cat (Cute Girl)",
        age: "Toddler (2-4 yrs)",
        location: "Cozy Home Living Room",
        ...
        perScene: "1 Character",
        nationality: "Global / Any",
        prop: "Fluffy Playful Cat 🐈",
        expression: "Sneaky Side-Eye",
        performance: "Funny Actions",
      },
      {
        icon: "🐱",
        title: "Dancing with Cat (Cute Boy)",
        age: "Toddler (2-4 yrs)",
        location: "Cozy Home Living Room",
        health: "Healthy & Active",
        vibe: "Funny & Mischievous",
      ...
      {
        icon: "🐱",
        title: "Dancing with Cat (Boy & Girl)",
        age: "Toddler (2-4 yrs)",
        location: "Cozy Home Living Room",
        health: "Healthy & Active",
        vibe: "Funny & Mischievous",
...
const KIDS_LOCATION_GROUPS: OptionGroupWithDesc[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: "Bakra Mandi (Eid Livestock Market)", label: "Bakra Mandi (بکرا منڈی)", desc: "Dusty outdoor livestock market with large decorated goats and cows for Eid." },
      { value: "Kulfi Thela (Neighborhood Street)", label: "Kulfi Cart / Thela (قلفی والا)", desc: "Narrow colorful neighborhood street with a traditional wooden Kulfi ice cream cart." },
      { value: "Desi Shaadi Stage (Marigold Decor)", label: "Shaadi/Mehndi Stage (شادی سٹیج)", desc: "Brightly lit wedding stage with yellow marigold flowers and glowing fairy lights." },
      { value: "Desi Village Courtyard (Aangan)", label: "Desi Village Courtyard (Aangan) 🏡", desc: "A traditional village home courtyard with a woven charpai (cot), a small tulsi plant, mud-brick walls, and warm sunlight." },
      { value: "Bustling Desi Mela (Village Fair)", label: "Bustling Desi Mela (Village Fair) 🎡", desc: "A colorful Indian fair setting with a giant wooden Ferris wheel, bright balloon sellers, toy stalls, and festive lights." },
      { value: "Desi Dhaba (Roadside Eatery)", label: "Desi Dhaba (Roadside Eatery) 🍛", desc: "A vibrant roadside dhaba with wooden benches, a glowing tandoor oven, and colorful truck-art decorations hanging around." },
      { value: "Desi Street / Mohalla (Neighborhood Gali)", label: "Desi Street / Mohalla (Neighborhood Gali) 🏏", desc: "A lively Indian neighborhood street with colorful houses, parked bicycles, and chalk drawings on the road where kids play." },
      { value: "Indian Mithai Shop (Sweet Shop)", label: "Indian Mithai Shop (Sweet Shop) 🍬", desc: "A bright and sweet-smelling shop displaying colorful laddoos, jalebis, and barfis in shiny glass counters." },
      { value: "Desi Chai Tapri (Roadside Tea Stall)", label: "Desi Chai Tapri (Roadside Tea Stall) ☕", desc: "A cozy little roadside tea stall with a steaming kettle, cutting-chai glass cups, and hanging snack packets." },
      { value: "Desi Rooftop (Chhat)", label: "Desi Rooftop (Chhat) 🪁", desc: "A sunny Indian home rooftop with clothes drying on a line, colorful flying kites in the sky, and potted plants." },
      { value: "Festive Wedding Setup (Shaadi / Mehndi)", label: "Festive Wedding Setup (Shaadi / Mehndi) ✨", desc: "A joyful location beautifully decorated with bright yellow and orange marigold flower garlands, colorful drapes, and glowing fairy lights." },
      { value: "Desi School Classroom", label: "Desi School Classroom 🎒", desc: "A classic Indian classroom with a big blackboard, wooden double desks, colorful charts on the wall, and kids' backpacks." },
    ],
  },
  {
...
const KIDS_VIBE_GROUPS: OptionGroupWithDesc[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: "Deadpan / Staring into Soul 😐", label: "Deadpan / Staring into Soul 😐", desc: "Character delivers the punchline with absolutely zero emotion, just staring blankly into the camera for maximum comedic effect." },
      { value: "Trying Not to Laugh 🤐", label: "Trying Not to Laugh 🤐", desc: "Character holds back a smile during the setup, then completely bursts out laughing at the punchline." },
      { value: "Awkward Silence 🦗", label: "Awkward Silence 🦗", desc: "Character delivers the joke, followed by a long, awkward stare while cricket noises play in the background." },
    ],
  },
  {
    ...
    <div className={`min-h-screen flex flex-col selection:bg-indigo-500 selection:text-white font-sans transition-colors duration-300 ${
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-3 sm:px-6 lg:px-8 py-5 sm:py-8 space-y-6 sm:space-y-8">
        ...
        <div ref={categoryControlsRef} className={`rounded-2xl sm:rounded-3xl p-5 sm:p-7 border shadow-xl relative z-30 space-y-6 transition-all duration-300 ${
          ...
          <div className={`sticky top-16 z-20 py-2 px-2.5 sm:px-4 mb-4 rounded-2xl border backdrop-blur-xl shadow-xl transition-all flex items-center justify-between gap-1.5 sm:gap-2 overflow-x-auto hide-scrollbar ${
            isLight
                ...
                <div className={`p-3 rounded-xl border space-y-2.5 my-1 ${
                  ...
                  <div className="flex flex-wrap items-center gap-1.5">
                    ...
                    {[
                      ...
                      { label: "👦👧 Brother & Sister", setup: "Brother & Sister", age: "Child (5-8 yrs)", location: "Cozy Home Living Room", vibe: "Funny & Mischievous", cameraShot: "Two-Shot" },
                      { label: "📱 Split View Call", setup: "Pakistani Fair Toddler Boy & Girl (Phone Call Split View)", age: "Toddler (2-4 yrs)", location: "Split Locations (Office & Living Room)", vibe: "Funny & Mischievous", cameraShot: "Phone Call Split View" },
                      ...
                      { label: "📱 Toddler Boy Call", setup: "Pakistani Fair Toddler Boy with Smartphone", age: "Toddler (2-4 yrs)", location: "Cozy Home Living Room", vibe: "Funny & Mischievous", cameraShot: "Speaker Focus" },
                      { label: "📱 Toddler Girl Call", setup: "Pakistani Fair Toddler Girl with Smartphone", age: "Toddler (2-4 yrs)", location: "Cozy Home Living Room", vibe: "Funny & Mischievous", cameraShot: "Speaker Focus" },
                      { label: "👦👦 Two Boy Friends", setup: "Two Boy Friends (Speaker & Listener) 👦👦", age: "Child (5-8 yrs)", location: "Vibrant Neighborhood Park", vibe: "Funny & Mischievous", cameraShot: "Alternating Close-Ups" },
                      { label: "👧👦 Girl & Boy", setup: "Girl Speaker and Boy Listener 👧👦", age: "Child (5-8 yrs)", location: "Vibrant Neighborhood Park", vibe: "Funny & Mischievous", cameraShot: "Alternating Close-Ups" },
                      { label: "👦👧 Boy & Girl", setup: "Boy Speaker and Girl Listener 👦👧", age: "Child (5-8 yrs)", location: "Vibrant Neighborhood Park", vibe: "Funny & Mischievous", cameraShot: "Alternating Close-Ups" },
                      ...
                      { label: "🤦‍♂️ Dad Joke", setup: "Father + Daughter (Girl + Abu)", age: "Child (5-8 yrs)", location: "Cozy Home Living Room", vibe: "Silly Kid / Funny", cameraShot: "Alternating Close-Ups" },
                      { label: "🔥 Savage Roast", setup: "One Cute Little Girl", age: "Child (5-8 yrs)", location: "Any / AI Decides", vibe: "Deadpan / Staring into Soul 😐", cameraShot: "Speaker Focus" },
                      { label: "🤐 Holding Laugh", setup: "One Cute Little Boy", age: "Child (5-8 yrs)", location: "Any / AI Decides", vibe: "Trying Not to Laugh 🤐", cameraShot: "Speaker Focus" },
                      { label: "🦗 Awkward Silence", setup: "Two Boy Friends (Speaker & Listener) 👦👦", age: "Child (5-8 yrs)", location: "Any / AI Decides", vibe: "Awkward Silence 🦗", cameraShot: "Alternating Close-Ups" },
