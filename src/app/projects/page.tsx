        ...
        <main className="flex-1 flex flex-col items-center justify-center p-6 text-center space-y-6 max-w-md mx-auto my-auto">
          ...
          <div className="space-y-2">
            ...
            <p className={`text-sm leading-relaxed ${isLight ? "text-slate-600 font-medium" : "text-slate-300"}`}>
              Please log in to your account (Hassan or Adi) to access saved workspace ideas and video projects.
            </p>
          </div>
          <button
            type="button"
  ...
  return (
    <div className={`min-h-screen flex flex-col selection:bg-indigo-500 selection:text-white transition-colors duration-300 ${
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
        {/* HERO SECTION */}
        <section className={`relative rounded-3xl p-5 sm:p-8 md:p-12 border overflow-hidden shadow-2xl transition-all ${
          isLight
            ? "bg-gradient-to-r from-indigo-100 via-purple-100 to-amber-50 border-indigo-200 text-slate-900 shadow-lg"
            : "glass-card border-indigo-500/20 text-slate-100"
        }`}>
          ...
          <div className="relative z-10 max-w-3xl space-y-5 sm:space-y-6">
            <div className={`inline-flex items-center gap-2 px-3 sm:px-3.5 py-1.5 rounded-full text-[11px] sm:text-xs font-bold border ${
